...
def RunMarkovModel(P1S, P2S, FirstToSets, FirstToTBPoints, Method, Viscosity, Mode = 'Simple'):
    ...
    if (Method == 1):
        ...
        [MatchDist,NumSetsDist,TotalNumGamesDist,AllSetScoresDist] = MarkovModelSecondImplementation(P1S,
...
def main():
    ...
    if (Approach == 1):
        ...
        [MatchDist, NumSetsDist, TotalNumGamesDist, AllSetScoresDist] = RunMarkovModel(P1S,P2S,3,7,
        Approach,Viscosity)
        print('Match Distribution: ', end = '')
        print(MatchDist)
        print('Number of Sets Distribution: ', end = '')
