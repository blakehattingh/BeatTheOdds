...
def MarkovModelSecondImplementation(P1S, P2S, P1TB, P2TB, FirstToSets, FirstToTBPoints, Mode, Iterations = 100, Tol = 0.001):
    ...
    if (Mode == 'Simple'):
        ...
        [MatchDist] = beliefpropagation(nodes,dist,parents,outcomes,info,Iterations,Tol,
                                                                    ['Match'])
        return MatchDist
    else:
        # Set up the Bayesain Network:
