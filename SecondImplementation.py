...
def MarkovModelSecondImplementation(P1S, P2S, FirstToSets, FirstToTBPoints,Viscosity,Iterations=100,Tol=0.001):
    # This function utilises the second approach to model a tennis match with a Markov Model.

    # Set up the Bayesain Network:
    [nodes, dist, parents, outcomes, info] = TennisMatchNetwork2Efficient(P1S, P2S, FirstToSets)
