...
def plotNumberOfGames(numGamesData3SA1, numGamesData3SA2, numGamesData5SA1, numGamesData5SA2):
    ...
    axesGames3S[0][0].bar(list(range(18,66)), numGamesData3SA1[0])
    '''axesGames3S[0][1].bar(range(18,66,1), numGamesData3SA1[1])
    axesGames3S[0][2].bar(range(18,66,1), numGamesData3SA1[2])

    axesGames3S[1][0].bar(range(18,66,1), numGamesData3SA2[0])
    axesGames3S[1][1].bar(range(18,66,1), numGamesData3SA2[1])
    axesGames3S[1][2].bar(range(18,66,1), numGamesData3SA2[2])'''
